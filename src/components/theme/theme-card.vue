        ...
        <div class="info-center">
          <div class="title">
            ...
            <span class="right more" v-else>
              <mi-dropdown @command="actionClick">
                <i class="mi-icon-more"></i>
                <mi-dropdown-menu slot="dropdown">
                  <mi-dropdown-item command="rename">{{getActionDisplayName('rename-theme')}}</mi-dropdown-item>
                  <mi-dropdown-item command="copy">{{getActionDisplayName('copy-theme')}}</mi-dropdown-item>
                  <mi-dropdown-item
                      command="delete"
                      style="color: #F56C6C;"
                    >
