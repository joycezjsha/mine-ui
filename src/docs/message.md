...
<div class="demo-block">
  <mine-button plain @click="open1">消息</mine-button>
  <mine-button plain @click="open2">成功</mine-button>
  <mine-button plain @click="open3">警告</mine-button>
  <mine-button plain @click="open4">错误</mine-button>
</div>
...
<div class="demo-block">
  <mine-button plain @click="open5">成功</mine-button>
  <mine-button plain @click="open6">警告</mine-button>
  <mine-button plain @click="open7">错误</mine-button>
</div>
