<template>
  <div
    class="mi-slider"
    :class="{ 'is-vertical': vertical, 'mi-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="mi-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="mi-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="mi-slider__stop mi-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="mi-slider__marks">
          <slider-marker
...
<script type="text/babel">
  import MiInputNumber from 'mine-ui/input-number';
