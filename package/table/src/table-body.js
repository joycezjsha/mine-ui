...
import MiCheckbox from 'mine-ui/checkbox';
import MiTooltip from 'mine-ui/tooltip';
...
export default {
    ...
    return (
      <table
        ...
        <tbody>
          ...
          <mi-tooltip effect={ this.table.tooltipEffect } placement="top" ref="tooltip" content={ this.tooltipContent }></mi-tooltip>
        </tbody>
      </table>
    );
  },
  ...
  watch: {
    ...
    'store.states.hoverRow'(newVal, oldVal) {
      ...
      raf(() => {
        const rows = this.$el.querySelectorAll('.mi-table__row');
  ...
  methods: {
    ...
    handleCellMouseEnter(event, row) {
      ...
      if (!(hasClass(cellChild, 'mi-tooltip') && cellChild.childNodes.length)) {
        return;
      }
    ...
    rowRender(row, $index, treeRowData) {
      ...
      let display = true;
      if (treeRowData) {
        rowClasses.push('mi-table__row--level-' + treeRowData.level);
      ...
      if (this.hasExpandColumn && isRowExpanded(row)) {
        ...
        return [[
          ...
          <tr key={'expanded-row__' + tr.key}>
            <td colspan={ this.columnsCount } class="mi-table__expanded-cell">
