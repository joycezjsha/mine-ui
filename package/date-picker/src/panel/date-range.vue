<template>
  <transition name="mi-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="mi-picker-panel mi-date-range-picker mi-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="mi-picker-panel__body-wrapper">
        <slot name="sidebar" class="mi-picker-panel__sidebar"></slot>
        <div class="mi-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="mi-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="mi-picker-panel__body">
          <div class="mi-date-range-picker__time-header" v-if="showTime">
            <span class="mi-date-range-picker__editors-wrap">
              <span class="mi-date-range-picker__time-picker-wrap">
                <mi-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="mi-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="mi-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <mi-input
                  size="small"
                  class="mi-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="mi-icon-arrow-right"></span>
            <span class="mi-date-range-picker__editors-wrap is-right">
              <span class="mi-date-range-picker__time-picker-wrap">
                <mi-input
                  size="small"
                  class="mi-date-range-picker__editor"
              ...
              <span class="mi-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <mi-input
                  size="small"
                  class="mi-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="mi-picker-panel__content mi-date-range-picker__content is-left">
            <div class="mi-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="mi-picker-panel__icon-btn mi-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="mi-picker-panel__icon-btn mi-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="mi-picker-panel__icon-btn mi-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="mi-picker-panel__icon-btn mi-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="mi-picker-panel__content mi-date-range-picker__content is-right">
            <div class="mi-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="mi-picker-panel__footer" v-if="showTime">
        <mi-button
          size="mini"
          type="text"
          class="mi-picker-panel__link-btn"
          @click="handleClear">
...
<script type="text/babel">
  ...
  import MiInput from 'mine-ui/input';
  ...
  export default {
    ...
    components: { TimePicker, DateTable, MiInput, MiButton }
  };
</script>
