<template>
  <transition
    ...
    <div
      v-show="visible"
      class="mi-time-range-picker el-picker-panel el-popper"
      :class="popperClass">
      <div class="mi-time-range-picker__content">
        <div class="mi-time-range-picker__cell">
          <div class="mi-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="mi-time-range-picker__body el-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="mi-time-range-picker__cell">
          <div class="mi-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="mi-time-range-picker__body el-time-panel__content">
            <time-spinner
      ...
      <div class="mi-time-panel__footer">
        <button
          type="button"
          class="mi-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="mi-time-panel__btn confirm"
          @click="handleConfirm()"
