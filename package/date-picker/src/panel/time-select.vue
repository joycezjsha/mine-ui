<template>
  <transition name="mi-zoom-in-top" @before-enter="handleMenuEnter" @after-leave="$emit('dodestroy')">
    <div
      ref="popper"
      v-show="visible"
      :style="{ width: width + 'px' }"
      :class="popperClass"
      class="mi-picker-panel time-select el-popper">
      <el-scrollbar noresize wrap-class="mi-picker-panel__content">
