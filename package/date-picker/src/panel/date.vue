<template>
  <transition name="mi-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="mi-picker-panel mi-date-picker mi-popper"
      :class="[{
      ...
      <div class="mi-picker-panel__body-wrapper">
        ...
        <div class="mi-picker-panel__body">
          <div class="mi-date-picker__time-header" v-if="showTime">
            <span class="mi-date-picker__editor-wrap">
              <mi-input
            ...
            <span class="mi-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <mi-input
                ref="input"
          ...
          <div
            class="mi-date-picker__header"
            :class="{ 'mi-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="mi-picker-panel__icon-btn mi-date-picker__prev-btn mi-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="mi-picker-panel__icon-btn mi-date-picker__prev-btn mi-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="mi-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="mi-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="mi-picker-panel__icon-btn mi-date-picker__next-btn mi-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="mi-picker-panel__icon-btn mi-date-picker__next-btn mi-icon-arrow-right">
            </button>
          </div>

          <div class="mi-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, MiInput, MiButton
    },
