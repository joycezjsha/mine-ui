<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="mi-month-table">
    <tbody>
...
<script type="text/babel">
  ...
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from '@/utils/util';
