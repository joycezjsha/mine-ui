<template>
  <div class="mi-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <el-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="mi-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="mi-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="mi-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="mi-time-spinner__arrow el-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="mi-time-spinner__arrow el-icon-arrow-down"></i>
        <ul class="mi-time-spinner__list" ref="hours">
          <li
            class="mi-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="mi-time-spinner__arrow el-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="mi-time-spinner__arrow el-icon-arrow-down"></i>
        <ul class="mi-time-spinner__list" ref="minutes">
          <li
            class="mi-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="mi-time-spinner__arrow el-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="mi-time-spinner__arrow el-icon-arrow-down"></i>
        <ul class="mi-time-spinner__list" ref="seconds">
          <li
