<template>
  <div
    ...
    <el-input
      ...
      <template slot="suffix">
        <i
          ...
          key="clear"
          class="mi-input__icon el-icon-circle-close"
    ...
    <div v-if="multiple" class="mi-cascader__tags">
      <el-tag
      ...
      <input
        ...
        type="text"
        class="mi-cascader__search-input"
    ...
    <transition name="mi-zoom-in-top" @after-leave="handleDropdownLeave">
      <div
        ...
        <el-scrollbar
          ...
          v-show="filtering"
          tag="ul"
          class="mi-cascader__suggestion-panel"
          view-class="mi-cascader__suggestion-list"
          ...
          <template v-if="suggestions.length">
            <li
              ...
              <span>{{ item.text }}</span>
              <i v-if="item.checked" class="mi-icon-check"></i>
            </li>
          </template>
          <slot v-else name="empty">
            <li class="mi-cascader__empty-text">{{ t('el.cascader.noMatch') }}</li>
          </slot>
        </el-scrollbar>
      </div>
    </transition>
...
import ElCascaderPanel from 'mine-ui/cascader-panel';
