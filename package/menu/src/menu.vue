    ...
    render (h) {
      const component = (
        <ul
          ...
          class={{
            'mi-menu--horizontal': this.mode === 'horizontal',
            'mi-menu--collapse': this.collapse,
            "mi-menu": true
          }}
        >
          { this.$slots.default }
        ...
        render(createElement, context) {
          const data = {
            ...
            on: {
              ...
              enter(el) {
                addClass(el, 'mi-opacity-transition');
                el.style.opacity = 1;
              },

              afterEnter(el) {
                removeClass(el, 'mi-opacity-transition');
                el.style.opacity = '';
              },
              ...
              beforeLeave(el) {
                ...
                if (hasClass(el, 'mi-menu--collapse')) {
                  removeClass(el, 'mi-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
                  addClass(el, 'mi-menu--collapse');
                } else {
                  addClass(el, 'mi-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
