<script>
  import MiCollapseTransition from '@/transitions/collapse-transition';
  ...
  export default {
    ...
    componentName: 'MiSubmenu',

    mixins: [menuMixin, Emitter, poperMixins],

    components: { MiCollapseTransition },
    ...
    computed: {
      ...
      menuTransitionName() {
        return this.rootMenu.collapse ? 'mi-zoom-in-left' : 'mi-zoom-in-top';
      },
      opened() {
    ...
    render(h) {
      ...
      const popupMenu = (
        <transition name={menuTransitionName}>
          <div
            ref="menu"
            v-show={opened}
            class={[`mi-menu--${mode}`, popperClass]}
            ...
            <ul
              role="menu"
              class={['mi-menu mi-menu--popup', `mi-menu--popup-${currentPlacement}`]}
      ...
      const inlineMenu = (
        <mi-collapse-transition>
          <ul
            role="menu"
            class="mi-menu mi-menu--inline"
            v-show={opened}
            style={{ backgroundColor: rootMenu.backgroundColor || '' }}>
            {$slots.default}
          </ul>
      ...
      ) ? 'mi-icon-arrow-down' : 'mi-icon-arrow-right';
      ...
      return (
        ...
        >
          ...
          >
            {$slots.title}
            <i class={[ 'mi-submenu__icon-arrow', submenuTitleIcon ]}></i>
          </div>
