<script>
  ...
  import ElRadio from 'mine-ui/radio';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="mi-icon-check el-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="mi-icon-loading el-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="mi-icon-arrow-right el-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="mi-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
