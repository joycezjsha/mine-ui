<template>
  <div class="mi-image">
    <slot v-if="loading" name="placeholder">
      <div class="mi-image__placeholder"></div>
    </slot>
    <slot v-else-if="error" name="error">
      <div class="mi-image__error">{{ t('el.image.error') }}</div>
    </slot>
    <img
      v-else
      class="mi-image__inner"
      v-bind="$attrs"
      v-on="$listeners"
      @click="clickHandler"
      :src="src"
      :style="imageStyle"
      :class="{ 'mi-image__inner--center': alignCenter, 'mi-image__preview': preview }">
