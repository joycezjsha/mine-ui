<template>
  <div
    ...
    aria-valuemax="100"
  >
    <div class="mi-progress-bar" v-if="type === 'line'">
      <div class="mi-progress-bar__outer" :style="{height: strokeWidth + 'px'}">
        <div class="mi-progress-bar__inner" :style="barStyle">
          <div class="mi-progress-bar__innerText" v-if="showText && textInside">{{content}}</div>
        </div>
      </div>
    </div>
    <div class="mi-progress-circle" :style="{height: width + 'px', width: width + 'px'}" v-else>
