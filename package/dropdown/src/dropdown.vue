<script>
  ...
  import MiButtonGroup from 'mine-ui/button-group';
  import { generateId } from '@/utils/util';

  export default {
    name: 'MiDropdown',

    componentName: 'MiDropdown',
    ...
    render(h) {
      ...
      let triggerElm = !splitButton
        ...
        : (<el-button-group>
          ...
          <el-button ref="trigger" type={type} size={dropdownSize} class="mi-dropdown__caret-button">
            <i class="mi-dropdown__icon el-icon-arrow-down"></i>
          </el-button>
        </el-button-group>);

      return (
        <div class="mi-dropdown" v-clickoutside={hide}>
          {triggerElm}
          {this.$slots.dropdown}
        </div>
      );
