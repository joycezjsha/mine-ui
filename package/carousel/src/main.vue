  ...
  <div
    ...
    <div
      ...
      <transition
        ...
        <button
          ...
          class="mi-carousel__arrow el-carousel__arrow--left">
      ...
      <transition
        ...
        <button
          ...
          @mouseleave="handleButtonLeave"
          @click.stop="throttledArrowClick(activeIndex + 1)"
          class="mi-carousel__arrow el-carousel__arrow--right">
    ...
    <ul
      ...
      <li
        ...
        <button class="mi-carousel__button">
